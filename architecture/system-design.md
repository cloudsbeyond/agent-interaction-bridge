...
The footer uses existing state references, preserves the suffix when an
identifier exceeds 12 characters, omits ellipses and decoration, and renders
...
It grants no routing or session authority.
