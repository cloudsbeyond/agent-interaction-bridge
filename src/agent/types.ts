...
export type AgentRuntimeEvent = AgentEvent;
export type AgentRuntimeRunOptions = AgentRunOptions;
export type AgentRuntimeRun = AgentRun;
export type AgentRuntimeAdapter = AgentAdapter;
